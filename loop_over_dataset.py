...
show_only_frames = [50, 51]  # [0, 1]  # [0, 200] # show only frames in interval for debugging

## Prepare Waymo Open Dataset file for loading
data_fullpath = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'dataset', data_filename) # adjustable path in case this script is called from another working directory
model = "darknet"   # "fpn-resnet" 
sequence = "1"   # "3"
# had to parameterize this
if model == 'fpn-resnet':
...
configs_det = det.load_configs(model_name='darknet')   # 'fpn_resnet'  # options are 'darknet', 'fpn_resnet'
...
exec_detection = ['bev_from_pcl', 'detect_objects', 'validate_object_labels', 'measure_detection_performance']   # [] ['bev_from_pcl'] ['bev_from_pcl', 'detect_objects']
exec_visualization = ['show_detection_performance']  # [] ['show_pcl'] ['show_range_image'] ['show_objects_in_bev_labels_in_camera']
